...
namespace Modix.Modules
{
    public class UserInfoModule : ModuleBase
    {
        ...
        public UserInfoModule(ILogger<UserInfoModule> logger, IUserService userService, IModerationOperations moderationOperations, IAuthorizationService authorizationService, IMessageRepository messageRepository)
        {
