...
namespace Modix.WebServer.Auth
{
    public static class ModixAuthenticationExtensions
    {
        ...
        {
            return builder.AddOAuth<DiscordAuthenticationOptions, ModixAuthenticationHandler>(
                DiscordAuthenticationDefaults.AuthenticationScheme, options =>
                {
                    ...
                    options.Events.OnRemoteFailure = context =>
                    {
                        ...
                        context.Response.Cookies.Append("Error", errorMessage,
