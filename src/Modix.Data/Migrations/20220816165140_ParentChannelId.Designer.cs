            ...
            modelBuilder.Entity("Modix.Data.Models.Core.GuildUserParticipationStatistics", b =>
                {
                    ...
                    b.ToView("No table or view exists for entity type GuildUserParticipationStatistics: This type can only be queried with raw SQL (.FromSqlXXX())");
                });
            ...
            modelBuilder.Entity("Modix.Data.Models.Core.MessageCountByDate", b =>
                {
                    ...
                    b.ToView("No table or view exists for entity type MessageCountByDate: This type can only be queried with raw SQL (.FromSqlXXX())");
                });
            ...
            modelBuilder.Entity("Modix.Data.Models.Core.MessageCountPerChannel", b =>
                {
                    ...
                    b.ToView("No table or view exists for entity type MessageCountPerChannel: This type can only be queried with raw SQL (.FromSqlXXX())");
                });
            ...
            modelBuilder.Entity("Modix.Data.Models.Core.PerUserMessageCount", b =>
                {
                    ...
                    b.ToView("No table or view exists for entity type PerUserMessageCount: This type can only be queried with raw SQL (.FromSqlXXX())");
                });
            ...
            modelBuilder.Entity("Modix.Data.Models.Emoji.EmojiStatsDto", b =>
                {
                    ...
                    b.ToView("No table or view exists for entity type EmojiStatsDto: This type can only be queried with raw SQL (.FromSqlXXX())");
                });
            ...
            modelBuilder.Entity("Modix.Data.Models.Emoji.GuildEmojiStats", b =>
                {
                    ...
                    b.ToView("No table or view exists for entity type GuildEmojiStats: This type can only be queried with raw SQL (.FromSqlXXX())");
                });
            ...
            modelBuilder.Entity("Modix.Data.Models.Emoji.SingleEmojiStatsDto", b =>
                {
                    ...
                    b.ToView("No table or view exists for entity type SingleEmojiStatsDto: This type can only be queried with raw SQL (.FromSqlXXX())");
                });
