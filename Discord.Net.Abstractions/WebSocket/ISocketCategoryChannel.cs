...
namespace Discord.WebSocket
{
    ...
    /// </summary>
    public class SocketCategoryChannelAbstraction : SocketGuildChannelAbstraction, ISocketCategoryChannel
    {
        /// <summary>
    ...
    /// </summary>
    public static class SocketCategoryChannelAbstractionExtensions
    {
        /// <summary>
